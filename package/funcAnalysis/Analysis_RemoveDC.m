...
if Settings.DoRemoveDC
    ...
    EEG.etc.JSON.BaselineCorrection = 'yes';
    EEG.etc.JSON.BaselineCorrectionMethod = 'mean subtraction';
    EEG.etc.JSON.BaselinePeriod = DCInterval;
else
    % Save the settings to JSON
    EEG.etc.JSON.BaselineCorrection = 'no';
    EEG.etc.JSON.BaselineCorrectionMethod = 'none';
    EEG.etc.JSON.BaselinePeriod = 'none';
end
