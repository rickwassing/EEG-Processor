...
if Settings.DoFilter
    ...
    if Settings.FilterSettings.DoNotch
        ...
        tmp = pop_firws(tmp, ...
            ...
            'forder', Settings.FilterSettings.FilterOrder, ...
            'minphase', 0);
        ...
        EEG.etc.JSON.SoftwareFilters.BandStop(idx).Order = Settings.FilterSettings.FilterOrder;
    end
    % Do bandpass filter
    if Settings.FilterSettings.DoBandpass
        ...
        EEG.etc.JSON.SoftwareFilters.BandPass(idx).Order = Settings.FilterSettings.FilterOrder;
    end
